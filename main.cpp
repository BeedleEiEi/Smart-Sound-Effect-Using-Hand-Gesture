...
int main(int argc, char *argv[])
{
    ...
    QSound sound("A:/Learning/ComputerVision/MiniProject/Smart-Sound-Effect-Using-Hand-Gesture/sound/rooster.wav");
    ...
    while(1){
        ...
        threshold(img_gray,img_threshold,100,255,THRESH_BINARY_INV+THRESH_OTSU);
